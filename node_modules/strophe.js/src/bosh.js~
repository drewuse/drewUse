...
Strophe.Bosh.prototype = {
    ...
    _restore: function (jid, callback, wait, hold, wind) {
         ...
         */
        this._conn.authzid = Strophe.getBareJidFromJid(jid);
        /** Variable: authcid
         *  Authentication identity (User name).
         */
        this._conn.authcid = Strophe.getNodeFromJid(jid);
        ...
        if (typeof session !== "undefined" &&
                   ...
                   (    typeof jid === "undefined" ||
                        jid === null ||
                        Strophe.getBareJidFromJid(session.jid) == this._conn.authzid ||
                        // If authcid is null, then it's an anonymous login, so
                        // we compare only the domains.
                        (this._conn.authcid === null  && Strophe.getDomainFromJid(session.jid) == jid)
                    )
        ) {
